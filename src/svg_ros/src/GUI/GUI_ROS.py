...
#________________________________________ BUTTONS''DEFINITIONS ______________________________________________________________________________________________________________________________
			...
			self.origen_angle.insert ( 0, '-2.094' )
			...
			self.range_angle.insert ( 0, '4.188' )
...
# _________________________________________G R I D S ______________________________________________________________________________
			...
			self.topLevelWindow.geometry("+%d+%d" % (50,50))
			self.topLevelWindow.wm_deiconify() #mostramos la ventana en su sitio        
...
#___________________________________________________________________________________________________ 
	...
	def plot_robot(self):
		...
		X2 = X + ROBOT_radio/2
		Y2 = Y + ROBOT_radio/2
		oval = C.create_oval(X1,Y1,X2,Y2, outline="yellow",fill="green", width=1)
...
if __name__ == '__main__':
	...
	planner.geometry("+%d+%d" % (50,290))
	planner.wm_deiconify() #mostramos la ventana en su sitio
	tk.mainloop()
